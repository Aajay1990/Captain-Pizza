...
import FullScreenStrip from './pages/FullScreenStrip';
...
function App() {
  ...
  const isTvRoute = location.pathname === '/tv-strip';
  const hideHeaderFooter = isAdminRoute || isPosRoute || isTvRoute;
    ...
    <div className="app-container">
      ...
      <main className={isAdminRoute ? 'admin-main-wrapper' : isPosRoute ? 'pos-main-wrapper' : isTvRoute ? 'tv-main-wrapper' : 'main-content'}>
        <Routes>
          ...
          <Route path="/tv-strip" element={<FullScreenStrip />} />
