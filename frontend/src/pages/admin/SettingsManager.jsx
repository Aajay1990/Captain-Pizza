        ...
        <div className="settings-manager card-style animate-fade-in">
            ...
            <div className="settings-section-card" style={{ marginTop: '25px', borderLeft: '4px solid #6a0dad' }}>
                ...
                <p style={{ fontSize: '0.82rem', color: '#888', marginBottom: '16px', marginTop: '-8px' }}>
                    Controls the scrolling ticker text shown at the bottom of the TV Strip screen (<code style={{ background: '#f5f5f5', padding: '2px 6px', borderRadius: '4px', fontSize: '0.78rem' }}>/tv-strip</code>).
                </p>

                <div className="setting-row" style={{ alignItems: 'flex-start', flexDirection: 'column', gap: '10px' }}>
                    <div className="setting-info">
                        <strong>📺 TV Ticker Bar Text</strong>
                        <p>Scrolling announcement text displayed at the bottom of the TV signage screen. Use • to separate items. Emojis supported.</p>
                    </div>
                    <textarea
                        className="premium-input-text w-full"
                        rows={3}
                        style={{ maxWidth: '100%', width: '100%', resize: 'vertical', fontWeight: '600', letterSpacing: '0.3px' }}
                        placeholder="e.g. 🍕 WELCOME TO CAPTAIN PIZZA! • FRESH PIZZAS • DINE-IN & TAKEAWAY AVAILABLE! 🛵"
                        defaultValue={getSettingValue('tv_ticker_text', '🍕 WELCOME TO CAPTAIN PIZZA! • FRESH WOOD-FIRED PIZZAS, BURGERS & SIDES • CHOOSE YOUR COMBO & ORDER AT THE COUNTER • DINE-IN & TAKEAWAY AVAILABLE! 🛵')}
                        onBlur={(e) => handleUpdate('tv_ticker_text', e.target.value)}
                    />
                    <small style={{ color: '#999', fontSize: '0.75rem' }}>
                        <i className="fas fa-info-circle"></i> Changes take effect the next time the TV Strip page is loaded or refreshed.
                    </small>
                </div>
            </div>
